        ...
        .then(data => {
            ...
            data.forEach(movie => {
                ...
                button.addEventListener('click', function () {
                    deleteFilm(movie.id);
                    removeFilmFromList(filmsList, movie.id);
                    filmsList.parentNode.removeChild(button, li);
                });
...
function removeFilmFromList(filmsList, id) {
    const filmToRemove = filmsList.querySelector(`li[data-id="${id}"]`);
    if (filmToRemove) {
        filmToRemove.remove();
    }
}
